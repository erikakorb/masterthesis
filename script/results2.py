...
if read_cond == True:
    ...
    endread = time.time()
    print('WRBH,BHBH, BHNS dataframes have been extracted and written in [min] ', (endread-start)/60.)
...
print('Time to elaborate all the SEVN output files [min]: ', (end-start)/60.)
