...
\subsection{Spectral classification of a Wolf-Rayet}
WN,WC etc con le righe spettrali

\subsection{Stellar winds}\label{subsec:stellarwinds}


\subsection{Evolution of a massive star into a Wolf-Rayet}\label{subsec:stellarevo}
\paragraph{Equilibria and timescales of the stellar evolution}
A star forms when a collapsing interstellar molecular cloud is able to reach central temperatures $\gtrsim 10^7$ K and ignite the hydrogen nuclear fusion. \cite{evostellare} The interior of the star becomes a hot plasma with a pressure gradient sufficient to balance the self-gravity: the star evolves in hydrostatic equilibrium. According to the virial theorem, perturbations of the hydrostatic equilibrium occur on the \emph{dynamical timescale}
...
where $R$ is the radius of the star, $M$ its mass and $G$ is the gravitational constant.

The energy released by the nuclear reactions is radiated from the surface and mantains the star in thermal equilibrium with $T_{\rm core} \approx const$. When the nuclear fuel is exhausted, the lower pressure gradient of the plasma causes a contraction of the star in order to maintain the hydrostatic equilibrium. Part of the gravitational energy is radiated away but part of it heats up the interior, until the it reaches the critical temperature to ignite heavier elements. The contraction is quasi-static and maintains the hydrostatic equilibrium. However, since a part of the energy produced by the contraction is not radiated away but heats up the interior, the process happens outside the thermal equilibrium and occurs in a \emph{thermal timescale} (also known as \emph{Kelvin-Helmholtz timescale})
